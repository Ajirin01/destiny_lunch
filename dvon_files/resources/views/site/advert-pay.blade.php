...
@section('upper-content')
    <div class="col-12 col-lg-12" style="margin-top: 150px">
        ...
        @endphp
        <form method="POST" action="{{ route('advertpay') }}" id="paymentForm" class="align-content-center text-align-center">
            @csrf
            <input type="hidden" name="amount" value="{{$sub_data->amount}}" /> <!-- Replace the value with your transaction amount -->
            <input type="hidden" name="payment_method" value="both" /> <!-- Can be card, account, both -->
            <input type="hidden" name="description" value="Adverts Subscription Payment" /> <!-- Replace the value with your transaction description -->
